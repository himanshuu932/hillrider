...
export default function DonationPage({languageType}) {
  ...
  const content = {
    en: {
      ...
      message:
        "Every contribution helps us bring hope, resources and opportunities to those who need them most. Donate today and be the reason for someone's smile tomorrow ❤",
      scan: "Scan to Donate",
    ...
    hi: {
      ...
      message:
        "आपका हर योगदान हमें ज़रूरतमंदों तक आशा, साधन और अवसर पहुँचाने में मदद करता है। आज दान करें और किसी की मुस्कान का कारण बनें ❤",
