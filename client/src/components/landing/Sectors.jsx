...
const sectorsData = [
  {
    ...
    images: [{ src: sevabharti, alt: 'Students in a classroom' }],
  },
  {
    id: "social",
    content: {
    ...
    images: [{ src: sevabharti2, alt: 'Community gathering for social work' }],
  },
  {
    id: "upliftment",
    content: {
    ...
    images: [{ src: sevabharti3, alt: 'Vocational skill development session' }],
  },
  {
    id: "environment",
    content: {
    ...
    images: [{ src: sevabharti4, alt: 'Environmental conservation effort' }],
  }
];
