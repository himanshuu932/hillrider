...
const sectorsData = [
  {
    ...
    images: [
      { src: sevabharti, alt: 'Students in a classroom' }
    ],
  },
  {
    content: {
    ...
    images: [
      { src: sevabharti2, alt: 'Community gathering for social work' }
    ],
  },
  {
    content: {
    ...
    images: [
      { src: sevabharti3, alt: 'Vocational skill development session' }
    ],
  },
  {
    content: {
    ...
    images: [
        { src: sevabharti4, alt: 'Environmental conservation effort' }
    ],
  }
];
